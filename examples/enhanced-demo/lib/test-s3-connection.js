...
const server_1 = require("pushduck/server");
async function testS3Connection() {
    console.log("🔧 Testing S3 connection...");
    try {
        // Test connection
        const connectionResult = await (0, server_1.validateS3Connection)();
        ...
        const files = await (0, server_1.listFiles)({ maxFiles: 5 });
        ...
        if (files.length > 0) {
            console.log("\n📄 Testing file info...");
            const fileInfo = await (0, server_1.getFileInfo)(files[0].key);
