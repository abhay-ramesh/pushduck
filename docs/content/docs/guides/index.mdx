...
<Cards>
  ...
  <Card 
    ...
    description="Implement paste-to-upload functionality with image previews"
    href="/docs/guides/paste-to-upload"
  >
    - Clipboard paste detection
    - Immediate and preview modes
    - Document and container scopes
    - Input field paste support
    
    **Perfect for**: Chat interfaces, forms, quick uploads
  </Card>
</Cards>
...
2. **Building image features?** → Check [Image Uploads](/docs/guides/image-uploads)
3. **Adding security?** → Review [Authentication](/docs/guides/security/authentication)
4. **Going to production?** → Use [Production Checklist](/docs/guides/production-checklist)
