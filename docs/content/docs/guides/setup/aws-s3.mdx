...
**Need help with AWS S3 setup?** Join our [Discord community](https://discord.gg/next-s3-uploader) or check out the [troubleshooting guide](/docs/guides/going-live/troubleshooting) for common issues.
