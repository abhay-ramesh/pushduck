---
title: CLI Setup
description: Get started with next-s3-uploader in seconds using the CLI tool
---
...
Get your file uploads working in under 2 minutes with our zero-configuration CLI tool.
...
<Steps>
  ...
  <Step>
    **Start uploading immediately**
    ...
    - ✅ API routes with type-safe configuration
...
**Ready in 2 Minutes**: The CLI handles all the complex setup so you can focus on building your application. Just run `npx next-s3-uploader init` and start uploading!
</Callout>