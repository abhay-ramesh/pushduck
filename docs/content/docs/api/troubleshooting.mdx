...
description: Common issues and solutions for next-s3-uploader
---
...
Common issues and solutions when using next-s3-uploader.
...
<Callout type="warn">
**Known Issue:** next-s3-uploader has compatibility issues with Next.js Turbo mode (`--turbo` flag).
</Callout>
...
**Solution:** File streaming is handled automatically by next-s3-uploader:
...
<Callout type="info">
**Need more help?** Create an issue on [GitHub](https://github.com/your-org/next-s3-uploader/issues) with detailed information about your setup and the error you're experiencing.
</Callout> 