...
<Callout type="info">
  ...
  [GitHub](https://github.com/your-org/pushduck) to influence what we
  build next.
</Callout>
...
<Callout type="info">
  ...
  board](https://github.com/your-org/pushduck/projects) for real-time
...
- **Code contributions** - Check our [contributing guide](https://github.com/your-org/pushduck/blob/main/CONTRIBUTING.md)
