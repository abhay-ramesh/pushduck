...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx next-s3-uploader init
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn dlx next-s3-uploader init
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx next-s3-uploader init
    ```
  </Tab>
</Tabs>
...
pnpm dlx next-s3-uploader init --provider cloudflare-r2
yarn dlx next-s3-uploader init --provider cloudflare-r2
bunx next-s3-uploader init --provider cloudflare-r2
```
