...
npx pushduck init --skip-examples
```
...
<Callout type="info">
**Need help?** The CLI includes built-in help: `npx pushduck --help`. For detailed documentation, see our [complete CLI reference](/docs/api/cli/cli-setup).
</Callout>
