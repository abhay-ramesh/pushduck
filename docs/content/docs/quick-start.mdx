...
<Callout type="success">
  **🚀 New!** Use our CLI for instant setup: `npx pushduck init` - handles everything automatically!
</Callout>
...
- 💬 **Community**: Join our [Discord community](https://discord.gg/pushduck)
- 🐛 **Issues**: Report bugs on [GitHub](https://github.com/your-org/pushduck)
- 📧 **Support**: Email us at support@pushduck.com

<Callout type="info">
  **Loving Pushduck?** Give us a ⭐ on
  [GitHub](https://github.com/your-org/pushduck) and help spread the
  word!
</Callout>
