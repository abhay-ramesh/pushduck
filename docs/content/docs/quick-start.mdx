...
Get **production-ready file uploads** working in your Next.js app in under 5 minutes. No complex configuration, no vendor lock-in.

<Callout type="info">
  This guide assumes you have a Next.js app with App Router. For Pages Router or
  other frameworks, see our [setup guides](/docs/guides/setup).
</Callout>
