...
<Cards>
  <Card 
    ...
    description="End-to-end typesafe file storage operations with tRPC procedures"
    href="/docs/integrations/trpc"
  >
    **Type-safe storage operations** via tRPC procedures.
    
    - Server procedures for file operations
    - Client-side upload handling  
    - Full TypeScript inference
    - Direct storage API access
    
    **Perfect for**: tRPC applications, type-safe file management
  </Card>
</Cards>
