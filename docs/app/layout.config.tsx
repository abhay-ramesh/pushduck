...
/**
 * Shared layout configurations - Better Auth inspired design
 *
    ...
    title: (
      <>
        <svg
          ...
          aria-label="Next S3 Uploader Logo"
          className="mr-2"
        >
          {/* S3 Bucket Icon */}
          <path
        ...
        <span className="font-bold text-lg">Next S3 Uploader</span>
      </>
    ),
    transparentMode: "top",
    children: (
      <div className="flex items-center gap-2 ml-auto">
        <a
          ...
          className="text-fd-muted-foreground hover:text-fd-foreground transition-colors p-2 rounded-md hover:bg-fd-muted"
