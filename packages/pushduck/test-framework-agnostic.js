...
try {
    ...
    const mockGetRequest = new Request('http://localhost:3000/api/upload?route=imageUpload', {
        method: 'GET'
    });
    ...
    console.log("✅ Universal GET handler works:", universalData.routes.length > 0);
